package ai.runapi.gpt4oimage.resources;
...
public final class TextToImageResource extends Gpt4oimageResource {
  /** API endpoint path for text to image operations. */
  public static final String ENDPOINT = "/api/v1/gpt_4o_image/text_to_image";
